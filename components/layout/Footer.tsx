...
export function Footer() {
  return (
    <footer className="bg-brand-dark text-white py-10 md:py-24 border-t-8 border-brand-orange">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-16 mb-10 md:mb-20">
        ...
        <div className="pt-8 md:pt-12 border-t-4 border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 text-white/40 text-xs sm:text-sm font-bold uppercase tracking-widest text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-12">
            ...
            <a href="#" className="hover:text-white transition-colors py-2 px-1">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
