        ...
        {steps.map((s, index) => (
          <React.Fragment key={s.num}>
            <div className="relative flex flex-col items-center justify-center z-10">
              <div className={`w-11 h-11 rounded-full flex items-center justify-center text-sm font-bold transition-colors duration-300 border-2 ${step > s.num ? 'bg-brand-dark text-white border-brand-dark' :
              ...
              <div className="space-y-5 md:space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-4 md:gap-6">
                  <div className="space-y-2">
                    ...
                    <select required value={formData.budget} onChange={e => updateData('budget', e.target.value)} className="w-full bg-brand-orange/10 dark:bg-brand-orange/10 border-2 border-brand-dark text-brand-dark h-12 rounded-xl px-4 pr-10 focus:border-brand-orange focus:ring-1 focus:ring-brand-orange outline-none appearance-none transition-colors">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                    <select required value={formData.timeline} onChange={e => updateData('timeline', e.target.value)} className="w-full bg-brand-orange/10 dark:bg-brand-orange/10 border-2 border-brand-dark text-brand-dark h-12 rounded-xl px-4 pr-10 focus:border-brand-orange focus:ring-1 focus:ring-brand-orange outline-none appearance-none transition-colors">
