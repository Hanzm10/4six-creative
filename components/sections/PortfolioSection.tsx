...
export function PortfolioSection() {
  ...
  return (
    <section id="portfolio" className="py-12 md:py-24 bg-brand-light grid-bg">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <Button variant="outline" className="creative-border creative-border-hover bg-white text-base md:text-lg px-4 py-3 md:px-8 md:py-6">View All Projects</Button>
        </div>
            ...
            >
              ...
              <div className="p-8 border-t-4 border-brand-dark flex justify-between items-center group-hover:bg-brand-dark group-hover:text-white transition-colors duration-300">
                <div>
                  ...
                  <h3 className="text-xl md:text-3xl font-display font-bold uppercase">{project.title}</h3>
                </div>
