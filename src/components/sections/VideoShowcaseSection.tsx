        ...
        <Carousel opts={{ loop: true }} className="w-full">
          ...
          <CarouselContent className="-ml-6 pb-6">
            {reelsList.map((reelUrl, idx) => (
              <CarouselItem key={`reel-${idx}`} className="pl-6 basis-[78%] sm:basis-[300px] md:basis-[320px] shrink-0">
                <div className="relative w-full aspect-[900/1840] overflow-hidden bg-transparent">
                  {/* Screen container */}
                  <div className="absolute top-[3.3%] left-[6.2%] w-[87.6%] h-[93.4%] rounded-[2rem] sm:rounded-[2.2rem] overflow-hidden bg-brand-dark flex items-center justify-center">
                    <iframe
                      src={reelUrl}
